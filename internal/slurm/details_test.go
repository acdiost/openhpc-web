...
func TestClientJobsParsesSqueueJSON(t *testing.T) {
	runner := &scriptedRunner{outputs: map[string][]byte{"squeue": []byte(`{
		"errors": [], "warnings": [],
		"jobs": [
			{"job_id":32940,"name":"simulation|phase2","user_name":"liyuxiang","user_id":{"set":true,"number":10001},"group_id":{"set":true,"number":10002},"account":"jfzx","partition":"GPU","job_state":["RUNNING"],"cpus":{"set":true,"number":16},"submit_time":{"set":true,"number":1704060000},"eligible_time":{"set":true,"number":1704063600},"start_time":{"set":true,"infinite":false,"number":1704067200},"end_time":{"set":false,"number":0},"time_limit":{"set":false,"infinite":true,"number":0},"node_count":{"set":true,"infinite":false,"number":1},"nodes":"node31","state_reason":"None","current_working_directory":"/home/liyuxiang/work/PVA-MPN/20","stdout_expanded":"/home/liyuxiang/work/PVA-MPN/20/out_32940.log","stderr_expanded":"/home/liyuxiang/work/PVA-MPN/20/err_32940.log","command":"/home/liyuxiang/work/PVA-MPN/20/md_gpu.slurm"},
